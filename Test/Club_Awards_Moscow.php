...
$query = "SELECT dogsparticipants.Awards, dogsparticipants.Nickname, dogsparticipants.Breed, club.Name_club FROM dogsparticipants INNER JOIN club ON club.id = dogsparticipants.Club_id AND club.Name_club = \"Москвич\" AND dogsparticipants.Awards IS NOT NULL";
