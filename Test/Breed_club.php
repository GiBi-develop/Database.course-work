...
$query = "SELECT dogsparticipants.Nickname, dogsparticipants.Breed, dogsparticipants.Old, club.Name_club FROM dogsparticipants LEFT OUTER JOIN club ON dogsparticipants.Club_id = club.id ORDER BY club.Name_club DESC";
...
else
{
    ...
    echo "<table class=\"table\"><tr><th>Имя собаки</th><th>Порода собаки</th><th>Возраст</th><th>Имя клуба</th></tr>";
    for($i = 0; $i < $rows ; ++$i)
    {
