...
$query = "SELECT dogsparticipants.Awards, dogsparticipants.Nickname, dogsparticipants.Breed, club.Name_club FROM dogsparticipants INNER JOIN club ON club.id = dogsparticipants.id AND dogsparticipants.Awards IS NOT NULL";
