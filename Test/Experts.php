...
$query = "SELECT experts.Name_expert, ring.Name_ring, exibition.Name_exibition FROM experts INNER JOIN ring ON experts.Ring_Number = ring.id INNER JOIN exibition ON ring.id = exibition.Ring";
...
else
{
    ...
    echo "<table class=\"table\"><tr><th>Имя эксперта</th><th>Название ринга</th><th>Название выставки</th></tr>";
    for($i = 0; $i < $rows ; ++$i)
    {
