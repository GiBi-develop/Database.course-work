...
$query = "SELECT dogsparticipants.Breed, club.Name_club, COUNT(dogsparticipants.Breed) As Count_of_dog FROM club INNER JOIN dogsparticipants ON club.id = dogsparticipants.Club_id AND club.Name_club = \"Собачонок\" GROUP BY dogsparticipants.Breed";
